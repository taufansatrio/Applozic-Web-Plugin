...
(function($applozic, w, d) {
    ...
    function Applozic(options) {
        ...
        function MckMessageLayout() {
                ...
                if (msg.fileMetaKeyStrings && typeof msg.fileMetas !== "undefined") {
                    if (typeof msg.fileMetas.length === "undefined") {
                        if (msg.fileMetas.contentType.indexOf("image") !== -1) {
                            ...
                            return '<a href="' + MCK_BASE_URL + FILE_PREVIEW_URL + '"' + msg.fileMetaKeyStrings + '" role="link" class="file-preview-link" target="_blank"><span class="file-detail"><div class="file-name"><img src="' + MCK_BASE_URL + '/resources/sidebox/images/ic_action_attachment.png" alt="File">&nbsp;' + msg.fileMetas.name + '</div>&nbsp;<div class="file-size">' + mckFileService.getFilePreviewSize(msg.fileMetas.size) + '</div></span></a>';
                        }
                    } else {
                        if (msg.fileMetas[0].contentType.indexOf("image") !== -1) {
                            ...
                            return '<a href="' + MCK_BASE_URL + FILE_PREVIEW_URL + msg.fileMetaKeyStrings + '" role="link" class="file-preview-link" target="_blank"><span class="file-detail"><div class="file-name"><img src="' + MCK_BASE_URL + '/resources/sidebox/images/ic_action_attachment.png" alt="File">&nbsp;' + msg.fileMetas[0].name + '</div>&nbsp;<div class="file-size">' + mckFileService.getFilePreviewSize(msg.fileMetas[0].size) + '</div></span></a>';
                        }
                    }
            ...
            _this.addContactsToSearchList = function(userIdArray) {
            ...
            _this.addContact = function(contact, $listId, message) {
                ...
                if (typeof latestCreatedAtTime === "undefined" || (message ? message.createdAtTime : "") > latestCreatedAtTime) {
        ...
        function MckInitializeChannel(token) {
            ...
            socket.onmessage = function(response) {
                ...
                } else if (messageType === "MT_DELIVERED_UPDATE") {
